...
robj *createLongsetObject(uint32_t len) {
    longset *is = longsetNew(len);
    robj *o = createObject(REDIS_LSET,is);
    o->encoding = REDIS_ENCODING_LONGSET;
    return o;
}
...
void freeListObject(robj *o) {
    ...
    case REDIS_ENCODING_ZIPLIST:
        ...
        break;
    default:
        parsePanic("Unknown list encoding type");
    }
}
...
void freeSetObject(robj *o) {
    ...
    case REDIS_ENCODING_LONGSET:
        zfree(o->ptr);
        break;
    default:
        parsePanic("Unknown set encoding type");
    }
}
...
void freeZsetObject(robj *o) {
    ...
    case REDIS_ENCODING_ZIPLIST:
        ...
        break;
    default:
        parsePanic("Unknown sorted set encoding");
    }
}
...
void freeHashObject(robj *o) {
    ...
    case REDIS_ENCODING_ZIPMAP:
        ...
        break;
    default:
        parsePanic("Unknown hash encoding type");
        break;
    }
}
...
void decrRefCount(void *obj) {
    ...
    if (o->refcount <= 0) parsePanic("decrRefCount against refcount <= 0");
    ...
    if (o->refcount == 1) {
        ...
        case REDIS_LSET: freeSetObject(o); break;
        case REDIS_ZSET: freeZsetObject(o); break;
        case REDIS_HASH: freeHashObject(o); break;
        default: parsePanic("Unknown object type"); break;
        }
        zfree(o);
    } else {
        o->refcount--;
...
robj *getDecodedObject(robj *o) {
    ...
    if (o->type == REDIS_STRING && o->encoding == REDIS_ENCODING_INT) {
        ...
        parsePanic("Unknown encoding type");
    }
}
...
char *strEncoding(int encoding) {
    ...
    case REDIS_ENCODING_LONGSET: return "longset";
